...
import { Pencil, Tag, Settings, Info, Hash, MapPin, Calendar, FileText, Plus } from "lucide-react"
...
type FormValues = z.infer<typeof equipmentUpdateSchema>

export function EditEquipmentModal({ open, onOpenChange, equipment, onSuccess }: EditEquipmentModalProps) {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      year_purchased: equipment.year_purchased || undefined,
    },
  })

  // Update form values when equipment changes
  React.useEffect(() => {
    if (open) {
      form.reset({
        name: equipment.name,
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <DialogDescription className="mt-0.5 text-sm text-slate-500">
                  Update equipment details for {equipment.name}. Required fields are marked with{" "}
